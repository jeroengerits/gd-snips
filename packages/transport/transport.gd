...
const CommandSignalBridge = preload("res://packages/transport/command/signal_bridge.gd")
const SignalBridge = preload("res://packages/transport/event/signal_bridge.gd")
